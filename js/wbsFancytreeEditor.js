...
// TODO move to jQuery(document).ready() ?
...
function initTree() {
    ...
    jQuery("#tree").fancytree({
      ...
      source: {
        ...
        data: { wbsRootId: wbsEditorSmartyData.wbsRootId,
                hasDetail: "0",
                action: "loadWBS"
        }
      },
      ...
      dnd5: {
         ...
         dragOver: function(targetNode, data) {
            ...
            //
// DEBUG: strangely, I only get "over", never "before" or "after", so I can't move between 2 other leafs
//console.log(targetNode.key, data.hitMode);
