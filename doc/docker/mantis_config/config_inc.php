...
$g_db_username            = 'root';
$g_db_password            = 'my_password';

$g_default_timezone       = 'Europe/Paris';

$g_crypto_master_salt     = 'rnChYB66v0sq3cJvHP+uJ0DVxb2EoHJOBbmwL+LPgUc=';
...
// $g_email_send_using_cronjob = OFF; # Disables sending of emails as soon as an action is performed. Emails are instead queued and must be sent by running scripts/send_emails.php periodically (cron)
