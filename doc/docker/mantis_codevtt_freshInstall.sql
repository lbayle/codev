...
--
-- Hôte : 127.0.0.1
-- Généré le :  Dim 24 mai 2020 à 00:53
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Wall posts';
...
('database_version', '20', 1, 0, 0, 0, 0, 0, 0, NULL, NULL),
...
CREATE TABLE `codev_currencies_table` (
...
CREATE TABLE `codev_timetrack_note_table` (
...
CREATE TABLE `codev_userdailycost_table` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `team_id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `mantis_tokens_table`
--

INSERT INTO `mantis_tokens_table` (`id`, `owner`, `type`, `value`, `timestamp`, `expiry`) VALUES
(5, 1, 4, '1', 1590273948, 1590274392);
...
(1, 'administrator', '', 'root@localhost', '63a9f0ea7bb98050796b649e85481845', 1, 0, 90, 6, 0, 0, '732aac42ba8df328cc8e19febef5910e2b4289473bc523f1d973862efb7380ad', 1590274092, 1521316138);
...
ALTER TABLE `codev_blog_activity_table`
  ADD PRIMARY KEY (`id`),
  ADD KEY `key1` (`blog_id`,`user_id`,`action`);
...
ALTER TABLE `codev_blog_table`
  ADD PRIMARY KEY (`id`),
  ADD KEY `date` (`date_submitted`),
  ADD KEY `key1` (`dest_team_id`,`dest_user_id`,`date_submitted`);
...
--
-- Index pour la table `codev_currencies_table`
--
ALTER TABLE `codev_currencies_table`
...
--
-- Index pour la table `codev_timetrack_note_table`
--
ALTER TABLE `codev_timetrack_note_table`
  ADD PRIMARY KEY (`timetrackid`,`noteid`);

--
-- Index pour la table `codev_userdailycost_table`
--
ALTER TABLE `codev_userdailycost_table`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `user_team_date` (`user_id`,`team_id`,`start_date`);
...
--
-- AUTO_INCREMENT pour la table `codev_userdailycost_table`
--
ALTER TABLE `codev_userdailycost_table`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
