...
--
-- Host: localhost    Database: mantis_1
-- ------------------------------------------------------
...
INSERT INTO `codev_config_table` VALUES ('database_version','14',1,0,0,0,0,0,0,NULL,NULL),('blogCategories','1:General,2:Imputations',3,0,0,0,0,0,0,NULL,NULL),('bug_resolved_status_threshold','80',1,0,0,0,0,0,0,NULL,'bug resolved threshold as defined in Mantis (g_bug_resolved_status_threshold)'),('customField_ExtId','1',1,0,0,0,0,0,0,NULL,''),('customField_effortEstim','2',1,0,0,0,0,0,0,NULL,''),('customField_type','3',1,0,0,0,0,0,0,NULL,''),('customField_MgrEffortEstim','4',1,0,0,0,0,0,0,NULL,''),('customField_deadLine','5',1,0,0,0,0,0,0,NULL,''),('customField_addEffort','6',1,0,0,0,0,0,0,NULL,''),('customField_backlog','7',1,0,0,0,0,0,0,NULL,''),('customField_deliveryDate','8',1,0,0,0,0,0,0,NULL,''),('externalTasksProject','4',1,0,0,0,0,0,0,NULL,'CodevTT Projet de taches externes'),('externalTasksCat_leave','5',1,0,0,0,0,0,0,NULL,''),('externalTasksCat_otherInternal','6',1,0,0,0,0,0,0,NULL,''),('adminTeamId','1',1,0,0,0,0,0,0,NULL,''),('issue_tooltip_fields','a:6:{i:0;s:10:\"project_id\";i:1;s:11:\"category_id\";i:2;s:8:\"custom_3\";i:3;s:15:\"codevtt_elapsed\";i:4;s:8:\"custom_7\";i:5;s:13:\"codevtt_drift\";}',2,0,0,0,0,0,0,NULL,'fields to be displayed in issue tooltip');
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `codev_plugin_table` (
...
LOCK TABLES `codev_plugin_table` WRITE;
/*!40000 ALTER TABLE `codev_plugin_table` DISABLE KEYS */;
/*!40000 ALTER TABLE `codev_plugin_table` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `mantis_tokens_table` VALUES (3,1,4,'1',1439070312,1439070644);
...
-- Dump completed on 2015-08-08 23:46:07
